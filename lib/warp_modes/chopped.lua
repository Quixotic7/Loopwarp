...
function Mode.source_items(Item)
  return {
    Item.item("mode_macro", "DUTY", {lockable = true, min = 0, max = 1, step = 0.01, snaps = {0, 0.25, 0.5, 0.75, 1}}),
    Item.item("chop_steps", "CHOP", {lockable = true, fn_fine = true, min = 0.05, max = 16, step = 0.05, fine_step = 0.25, snaps = {0.25, 0.5, 1, 2, 4, 8, 16}}),
    Item.item("chop_loop_mode", "LOOP", {lockable = true, options = 3, slow_option = 3}),
